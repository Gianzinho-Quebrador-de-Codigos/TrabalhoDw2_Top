...
app.post('/alterar/:id',function(req, res){
    ...
    pool.query(`
                UPDATE estudantes SET
		            nome = '${req.body.exampleInputNome1}',
                    dtnascimento = '${req.body.exampleInputData1}',
                    cpf = '${req.body.exampleInputCpf1}',
                    email = '${req.body.exampleInputEmail1}',
                    telefone = '${req.body.exampleInputTelefone1}',
                    estadocivil = ${req.body.disabledSelect},
                    curso = '${req.body.exampleInputCurso1}'
	            WHERE 
                    ID = ${id}`)
                .then(function(retorno){
